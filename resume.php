                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="timeline">
                                    ...
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Programação WEB</h5>
                                        <span class="timeline__period">2020 — 2020</span>
                                        <p class="timeline__description">
                                            Instituto Federal de Ciencia e Tecnologia de Tocantins - IFTO</p>
                                    </article>

                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">
                                            Tecnológico em Análise e Desenvolvomento de Sistemas
                                        </h5>
                                        <span class="timeline__period">2020 — 2021</span>
                                        <p class="timeline__description">UNOPAR</p>
                                    </article>

                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">
                                            Jornada Bootcamp Full Stack Developer
                                        </h5>
                                        <span class="timeline__period">2020 — 2020</span>
                                        <p class="timeline__description">Jornada FullStack</p>
                                    </article>

                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Licenciatura em Computação</h5>
                                        <span class="timeline__period">2009 — [---]</span>
                                        <p class="timeline__description">
                            ...
                            <div class="col-12">
                                ...
                                <div class="timeline">
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Digitador Secretaria de Saúde</h5>
                                        <span class="timeline__period">2010 — Presente</span>
                                        <p class="timeline__description">Alimentar sistemas de informação em saúde ....</p>
                                    </article>

                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Professor/Orientador - SENAC/PB</h5>
                                    ...
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Programador</h5>
                                        <span class="timeline__period">2005 — 2018</span>
                                        <p class="timeline__description">Dentre as principais responsabilidades,
                                            destacam desenvolver e manter um sistema de gestão e automação comercial
                                            escrito em Delphi.
                                            Desenvolver e manter um banco de dados Firebird
                                        </p>
                                    </article>
                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Estagiário - Lab Meteorologia da PB</h5>
                                        <span class="timeline__period">2004 — 2005</span>
                                        <p class="timeline__description">Dentre as principais responsabilidades,
                                            destacam auxiliar na manutenção de um sistema [em Delphi 6 e Oracle 10] de coleta de dados
                                            pluviométricos e Meteorologicos, ajudando no processo de migração [reengenharia]
                                            do sistema para a linguagem Java.
                                        </p>
                                    </article>
                                ...
                                <div class="box box__border">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="33"
                                            aria-valuemin="0" aria-valuemax="100">
                                            <div class="progress-text"><span>WordPress</span><span>33%</span></div>
                                        </div>
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="25"
                                            aria-valuemin="0" aria-valuemax="100">
                                            <div class="progress-text"><span>Node.js</span><span>25%</span></div>
                                        </div>
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="40"
                                            aria-valuemin="0" aria-valuemax="100">
                                            <div class="progress-text"><span>CSS</span><span>40%</span></div>
                                        </div>
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="50"
                                            aria-valuemin="0" aria-valuemax="100">
                                            <div class="progress-text"><span>HTML</span><span>50%</span></div>
                                        </div>
